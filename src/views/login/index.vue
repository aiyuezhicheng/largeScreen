...
import { loginApi, getUserInfoApi } from '@/api/path'
        ...
        if (userInfoRes) {
          ...
          if (IsOk) {
            ...
            systemStore.setItem(SystemStoreEnum.USER_INFO, {
              ...
              [SystemStoreUserInfoEnum.USER_LOGINNAME]: LoginName,
              [SystemStoreUserInfoEnum.USER_PROJECTID]: ProjectID,
              [SystemStoreUserInfoEnum.USER_TOKEN]: token,
              t
            })
          } else {
            window['$message'].error(window['$t']('http.error_message') + ErrorMsg)
          }
